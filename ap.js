...
class DarkMode {
  constructor() {
    ...
    set darkMode(darkMode) {
      darkMode.matches ? document.body.classList.add("dark-theme") : document.body.classList.remove("dark-theme");
    }
}
...
class SafariTabLayout {
  constructor() {
    ...
    set safari(safari) {
          ...
          metaColor.setAttribute('content', headerDark) : metaColor.setAttribute('content', headerLight);
    }
}

  /* Google Chrome Auto Dark Mode off (experimental) */
...
const safariTabLayout = new SafariTabLayout();
const chromeAutoDarkOff = new ChromeAutoDarkOff();